# MIPS-Routine
Implement Full Search Based Variable Block Size Motion Estimation using MIPS ISA with the diagonal search pattern, and then implement datapath components.

## Overview

"vbsme.s" is the searching algorithm written in C and then implemented in MIPS.
The verilog files act as our datapath components.
